# BOOTSTRAP.md — Forge Startup Checklist
...
3. **Update HANDOFF.md from last session** — before reading it, do this first:
   - Find your most recent session file: `ls -t /data/.openclaw/agents/forge/sessions/*.jsonl | head -1`
...
7. Check `memory/` for recent context and active reviews

## Quick Reference

- **Owner:** Nick Gallick (@VPSClaw, ID: 7474858103)
- **Workspace:** /data/.openclaw/workspace-forge
- **Channel:** Telegram (@ForgeVPSBot)
- **Model:** anthropic/claude-opus-4-6

## Chain of Command
Nick (CEO) → ClawExpert (COO) → MaksPM (Orchestrator) → Forge

## Review Severity Levels
CRITICAL · HIGH · MEDIUM · LOW · GAS (blockchain)
