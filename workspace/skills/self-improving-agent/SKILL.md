...
- verify the pattern is repeated and durable
- check installed skills for overlap
- if overlap exists, compare first instead of creating a duplicate
...
## References for Nick's setup

- Read `reference/openclaw-memory-adapter.md` when working inside OpenClaw
- Read `reference/nick-promotion-rules.md` before promoting patterns or extracting skills
- Read `reference/memory-categories.md` when deciding where a durable lesson belongs
- Read `reference/mistake-prevention-checklist.md` before major work or after repeated failures
- Read `reference/project-memory-summary-template.md` when a project deserves its own summary note
- Read `reference/session-closeout-template.md` after significant work sessions

## Bundled scripts
- `scripts/init_memory_templates.sh` — initialize category-based durable memory headings safely
- `scripts/create_project_memory_summary.sh` — create a project-specific memory summary stub
