...
6. Run Pass 2 (destruction attempt) on any that survive vetting.
7. Send Telegram report for the survivor, or send "nothing survived" with kill list.
8. Insert record into scout_ideas table.
