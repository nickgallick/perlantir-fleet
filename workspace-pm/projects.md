...
| Project | Status | URL | Last Activity | Next Step | Blocker |
|---------|--------|-----|---------------|-----------|---------|
| MathMind | ✅ Complete | N/A (Expo, not Vercel) | 2026-03-21 | Ready for EAS Build + App Store submission | Apple Developer account pending |
...
## Pipeline Stage Tracking (updated 2026-03-19)
Projects should go through these stages in order:
1. Strategy (nick-product-strategist)
2. Competitor + aspiration screenshots
3. Design Director → Stitch → Design System → Brief
4. Schema Design
5. Build (Claude Code)
6. Deploy (Vercel)
7. QA: vercel-qa + visual-design-review + deep-uat
8. Fix loop (max 3 attempts)
9. ✅ Done — all 3 QA steps pass
